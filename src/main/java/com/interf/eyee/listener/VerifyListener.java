package main.java.com.interf.eyee.listener;
...
import main.java.com.interf.eyee.utils.assertutils.Verify;
...
public class VerifyListener extends TestListenerAdapter {
    ...
    private void handleVerify(ITestResult tr){
        if(!Verify.flag){

...
import main.java.com.interf.eyee.entity.forcase.GetMerchantListDataEntity;
...
public class GetMerchantList extends BaseCase {
	...
	public void getMerchantListTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new GetMerchantListDataEntity());

package main.java.com.interf.eyee.script.home;
...
import main.java.com.interf.eyee.entity.forcase.GetBtcBannerListDataItemEntity;
...
public class GetBtcBannerList extends BaseCase {
	...
	public void getBtcBannerListTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, GetBtcBannerListDataItemEntity.class);

...
import main.java.com.interf.eyee.entity.forcase.NewerDataEntity;
...
public class Newer extends BaseCase {
	...
	public void newerTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new NewerDataEntity());

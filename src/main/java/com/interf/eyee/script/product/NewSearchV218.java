...
import main.java.com.interf.eyee.entity.forcase.NewSearchV218DataEntity;
...
public class NewSearchV218 extends BaseCase {
	...
	public void newSearchV218Test(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new NewSearchV218DataEntity());

...
import main.java.com.interf.eyee.entity.forcase.BrandAllDataItemEntity;
...
public class BrandAll extends BaseCase {
	...
	public void brandAllTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, BrandAllDataItemEntity.class);

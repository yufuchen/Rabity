...
import main.java.com.interf.eyee.entity.forcase.TabBrandsDataItemEntity;
...
public class TabBrands extends BaseCase {
	...
	public void tabBrandsTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, TabBrandsDataItemEntity.class);

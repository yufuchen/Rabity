package main.java.com.interf.eyee.script.article;
...
import main.java.com.interf.eyee.entity.forcase.NewsRecommendAndSearchDataEntity;
...
public class NewsRecommendAndSearch extends BaseCase {
	...
	public void newsRecommendAndSearchTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new NewsRecommendAndSearchDataEntity());

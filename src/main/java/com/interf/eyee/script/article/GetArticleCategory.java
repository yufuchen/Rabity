...
import main.java.com.interf.eyee.entity.forcase.GetArticleCategoryDataItemEntity;
...
public class GetArticleCategory extends BaseCase {
	...
	public void getArticleCategoryTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, GetArticleCategoryDataItemEntity.class);

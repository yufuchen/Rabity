...
import main.java.com.interf.eyee.entity.forcase.UpdateInfoDataEntity;
...
public class UpdateInfo extends BaseCase {
	private Log log = new Log(this.getClass());

	@Test(dataProvider = "BaseData", dataProviderClass = BaseDataProvider.class)
	public void updateInfoTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new UpdateInfoDataEntity());

...
import main.java.com.interf.eyee.entity.forcase.HobbyLabelsDataItemEntity;
...
public class HobbyLabels extends BaseCase {
	...
	public void hobbyLabelsTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, HobbyLabelsDataItemEntity.class);

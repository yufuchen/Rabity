...
import main.java.com.interf.eyee.entity.forcase.ActPreListTestCaseDataItemEntity;
...
public class ActPreList extends BaseCase {
	...
	public void actPreListTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, ActPreListTestCaseDataItemEntity.class);

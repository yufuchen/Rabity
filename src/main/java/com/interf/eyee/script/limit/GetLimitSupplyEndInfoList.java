package main.java.com.interf.eyee.script.limit;
...
import main.java.com.interf.eyee.entity.forcase.GetLimitSupplyEndInfoListDataItemEntity;
...
public class GetLimitSupplyEndInfoList extends BaseCase {
	...
	public void getLimitSupplyEndInfoListTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, GetLimitSupplyEndInfoListDataItemEntity.class);

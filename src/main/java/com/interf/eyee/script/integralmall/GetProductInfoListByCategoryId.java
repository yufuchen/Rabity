...
import main.java.com.interf.eyee.entity.forcase.GetProductInfoListByCategoryIdDataItemEntity;
...
public class GetProductInfoListByCategoryId extends BaseCase {
	...
	public void getProductInfoListByCategoryIdTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, GetProductInfoListByCategoryIdDataItemEntity.class);

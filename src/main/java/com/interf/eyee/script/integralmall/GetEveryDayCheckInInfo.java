...
import main.java.com.interf.eyee.entity.forcase.GetEveryDayCheckInInfoDataEntity;
...
public class GetEveryDayCheckInInfo extends BaseCase {
	...
	public void getEveryDayCheckInInfoTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new GetEveryDayCheckInInfoDataEntity());

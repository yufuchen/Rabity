...
import main.java.com.interf.eyee.entity.forcase.GetEverydayMissionProgressInfoDataEntity;
...
public class GetEverydayMissionProgressInfo extends BaseCase {
	...
	public void getEverydayMissionProgressInfoTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new GetEverydayMissionProgressInfoDataEntity());

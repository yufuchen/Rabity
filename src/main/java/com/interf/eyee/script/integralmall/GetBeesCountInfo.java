...
import main.java.com.interf.eyee.entity.forcase.GetBeesCountInfoDataEntity;
...
public class GetBeesCountInfo extends BaseCase {
	...
	public void getBeesCountInfoTest(String testName, TestCaseEntity testCase) {
		...
		log.info("接口返回 : " + body);
		ResponseEntity response = ResponseUtil.handle(body, new GetBeesCountInfoDataEntity());
